...
public class favFragment extends Fragment {
    ...
    private favViewModel goodsViewModel;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        goodsViewModel = ViewModelProviders.of(this).get(favViewModel.class);
...
//                });
        goodsViewModel.getText().observe(this, new Observer<String>() {
            ...
            public void onChanged(@Nullable String s) {
               ...
               UserUI.thisUser.clearMyfev();
               for(int i=0;i<l.size();i++)
                 UserUI.thisUser.setMyfav(l.get(i));
                fillGoods(UserUI.thisUser.getMyfav(), root);
